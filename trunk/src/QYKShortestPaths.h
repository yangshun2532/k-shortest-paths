...
namespace asu_emit_qyan
{
	...
	private: // methods
		...
		void _Restore4CostAjustment(vector<int> vertices_list, int start_node_id, int end_node_id, bool is_deviated_node = false);
		void _Update4CostUntilNode(int node_id);
